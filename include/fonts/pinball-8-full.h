...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0x80, 0x00, 0x00, 0x00, 0x4C, 0x42, 0x00, 0x01, 0x33, 0x33, 0x64, 0x00,
  0x00, 0x30, 0xC3, 0x04, 0x00, 0x00 };
...
// Approx. 1342 bytes -  but your mileage may vary.
