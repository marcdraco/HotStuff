...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0x04, 0x08, 0x80, 0xE0, 0x00, 0x06, 0x66, 0x00, 0x60, 0xF3, 0xC0, 0xE8,
  0x44, 0x10, 0x04, 0x21, 0x18, 0x00, 0x40, 0x80, 0x00, 0x20, 0x08, 0x63,
  0x18, 0x80, 0x00, 0x00, 0x00, 0x4C, 0x42, 0x00, 0x01, 0x33, 0x33, 0x64 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   779,   5,   1,   9,    1,   -4 },   // 0x45 '-' 
  {91,   780,   5,  10,   9,    1,   -9 },   // 0x46 '[' 
  {93,   787,   5,  10,   9,    2,   -9 },   // 0x47 ']' 
  {40,   794,   4,  10,   9,    1,   -9 },   // 0x48 '(' 
  {41,   799,   4,  10,   9,    2,   -9 }   // 0x49 ')' 
};
...
// Approx. 1336 bytes -  but your mileage may vary.
