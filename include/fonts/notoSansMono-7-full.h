...
const uint8_t HotStuff7Bitmaps[] PROGMEM = {
  ...
  0x0F, 0xF0, 0xF2, 0x49, 0x24, 0x92, 0x4E, 0xE4, 0x92, 0x49, 0x24, 0x9E,
  0x6B, 0x49, 0x24, 0x91, 0x30, 0xC8, 0x92, 0x49, 0x2D, 0x60 };
...
const gfxglyph_t HotStuff7Glyphs[] PROGMEM = {
  ...
  {45,   529,   4,   1,   8,    2,   -4 },   // 0x45 '-' 
  {91,   530,   3,  13,   8,    3,   -9 },   // 0x46 '[' 
  {93,   535,   3,  13,   8,    2,  -10 },   // 0x47 ']' 
  {40,   540,   3,  12,   8,    3,   -9 },   // 0x48 '(' 
  {41,   545,   3,  12,   8,    2,   -9 }   // 0x49 ')' 
};
