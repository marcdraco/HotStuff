...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0x87, 0xFC, 0xFF, 0x81, 0xFF, 0x7F, 0xFF, 0xFF, 0xF1, 0x8C, 0x63, 0x18,
  0xC6, 0x31, 0x8C, 0x7F, 0xE0, 0xFF, 0xC6, 0x31, 0x8C, 0x63, 0x18, 0xC6,
  0x31, 0xFF, 0xE0, 0x08, 0x73, 0x9C, 0x63, 0x0C, 0x30, 0xC3, 0x0C, 0x18,
  0x70, 0xE1, 0xC2, 0x43, 0x87, 0x0E, 0x18, 0x30, 0xC3, 0x0C, 0x31, 0xC6,
  0x39, 0xCE, 0x10 };
...
const gfxglyph_t HotStuff9Glyphs[] PROGMEM = {
  ...
  {45,   749,   8,   2,  11,    1,   -5 },   // 0x45 '-' 
  {91,   751,   5,  15,  11,    3,  -11 },   // 0x46 '[' 
  {93,   761,   5,  15,  11,    3,  -11 },   // 0x47 ']' 
  {40,   771,   6,  16,  11,    2,  -11 },   // 0x48 '(' 
  {41,   783,   6,  16,  11,    2,  -11 }   // 0x49 ')' 
};
...
// Approx. 1327 bytes -  but your mileage may vary.
