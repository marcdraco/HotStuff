...
const uint8_t HotStuff12Bitmaps[] PROGMEM = {
  ...
  0x00, 0xC0, 0x00, 0x0C, 0x1F, 0x83, 0xF0, 0x7E, 0x0F, 0xFF, 0xFF, 0x37,
  0x86, 0xF0, 0x00, 0x60, 0x3C, 0x07, 0x80, 0x30, 0x00, 0x00, 0xC0, 0x78,
  0x0C, 0xDE, 0x1B, 0xC0, 0x07, 0x80, 0xF0, 0xC1, 0x98, 0x33, 0x00, 0x60,
  0x00, 0x07, 0xBC, 0xF7, 0x86, 0x00, 0xC0, 0x00, 0x03, 0x00, 0x60, 0x0C,
  0x01, 0x80 };
...
const gfxglyph_t HotStuff12Glyphs[] PROGMEM = {
  ...
  {99,   239,  11,  12,  13,    1,  -11 },   // 0x0E 'c' 
  {102,   256,  11,  16,  13,    1,  -15 }   // 0x0F 'f' 
};
...
// Approx. 404 bytes -  but your mileage may vary.
