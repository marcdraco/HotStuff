...
const uint8_t HotStuff12Bitmaps[] PROGMEM = {
  ...
  0xB4, 0x03, 0xEC, 0xFF, 0x80, 0x07, 0xFC, 0xFF, 0xFF, 0xF0, 0x7F, 0xFB,
  0x06, 0x0C, 0x18, 0x30, 0x60, 0xC1, 0x83, 0x06, 0x0C, 0x18, 0x30, 0x60,
  0xC1, 0x83, 0x06, 0x0C, 0x18, 0x3F, 0xFE, 0x7F, 0xFC, 0x18, 0x30, 0x60,
  0xC1, 0x83, 0x06, 0x0C, 0x18, 0x30, 0x60, 0xC1, 0x83, 0x06, 0x0C, 0x18,
  0x30, 0x60, 0xDF, 0xFE, 0x1B, 0xF9, 0x8C, 0x63, 0x18, 0xC6, 0x31, 0x8C,
  0x63, 0x18, 0xC6, 0x31, 0x8E, 0x3C, 0x60, 0xC7, 0x8E, 0x31, 0x8C, 0x63,
  0x18, 0xC6, 0x31, 0x8C, 0x63, 0x18, 0xC6, 0x33, 0xFB, 0x00 };
...
const gfxglyph_t HotStuff12Glyphs[] PROGMEM = {
  ...
  {45,  1483,  10,   2,  14,    2,   -9 },   // 0x45 '-' 
  {91,  1486,   7,  24,  10,    2,  -20 },   // 0x46 '[' 
  {93,  1507,   7,  24,  10,    0,  -20 },   // 0x47 ']' 
  {40,  1528,   5,  23,   9,    2,  -19 },   // 0x48 '(' 
  {41,  1543,   5,  23,   9,    1,  -19 }   // 0x49 ')' 
};
...
// Approx. 2090 bytes -  but your mileage may vary.
