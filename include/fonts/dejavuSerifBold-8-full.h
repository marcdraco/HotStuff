...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0xFF, 0x81, 0xFF, 0xFF, 0xC0, 0xFC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCF,
  0xF3, 0x33, 0x33, 0x33, 0x33, 0x33, 0x3F, 0x12, 0x64, 0xCC, 0xCC, 0xCC,
  0xC4, 0x62, 0x10, 0x84, 0x62, 0x33, 0x33, 0x33, 0x32, 0x64, 0x80 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   951,   5,   2,   7,    1,   -4 },   // 0x45 '-' 
  {91,   953,   4,  14,   8,    2,  -11 },   // 0x46 '[' 
  {93,   960,   4,  14,   8,    1,  -11 },   // 0x47 ']' 
  {40,   967,   4,  15,   8,    2,  -11 },   // 0x48 '(' 
  {41,   975,   4,  15,   8,    1,  -11 }   // 0x49 ')' 
};
...
// Approx. 1515 bytes -  but your mileage may vary.
