...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0x7F, 0xFF, 0xF0, 0xF0, 0xF0, 0x0F, 0x7F, 0xFF, 0xFE, 0x31, 0x8C, 0x63,
  0x18, 0xC6, 0x31, 0x8C, 0x63, 0x18, 0xF8, 0xF8, 0xC6, 0x31, 0x8C, 0x63,
  0x18, 0xC6, 0x31, 0x8C, 0x63, 0xF8, 0x3F, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
  0xCC, 0xCC, 0xF3, 0xCF, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0xFC };
...
const gfxglyph_t HotStuff9Glyphs[] PROGMEM = {
  ...
  {45,   906,   8,   2,  11,    1,   -7 },   // 0x45 '-' 
  {91,   908,   5,  17,   8,    2,  -14 },   // 0x46 '[' 
  {93,   919,   5,  17,   8,    1,  -14 },   // 0x47 ']' 
  {40,   930,   4,  18,   7,    2,  -15 },   // 0x48 '(' 
  {41,   939,   4,  18,   7,    1,  -15 }   // 0x49 ')' 
};
...
// Approx. 1480 bytes -  but your mileage may vary.
