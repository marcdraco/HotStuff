...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0x00, 0x01, 0x8C, 0x00, 0x00, 0x3F, 0x80, 0x00, 0x07, 0xB1, 0x8C, 0x63,
  0x18, 0xC6, 0x31, 0x8C, 0x78, 0x00, 0x07, 0x8C, 0x63, 0x18, 0xC6, 0x31,
  0x8C, 0x63, 0x78, 0x00, 0x00, 0x01, 0x08, 0x43, 0x0C, 0x30, 0xC3, 0x0C,
  0x30, 0x40, 0x81, 0x00, 0x00, 0x00, 0x04, 0x08, 0x10, 0x61, 0x86, 0x18,
  0x61, 0x86, 0x10, 0x84, 0x00, 0x00 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   964,   9,   3,   9,    0,   -5 },   // 0x45 '-' 
  {91,   968,   5,  15,   9,    2,  -12 },   // 0x46 '[' 
  {93,   978,   5,  15,   9,    2,  -12 },   // 0x47 ']' 
  {40,   988,   6,  17,   9,    2,  -13 },   // 0x48 '(' 
  {41,  1001,   6,  17,   9,    2,  -13 }   // 0x49 ')' 
};
...
// Approx. 1546 bytes -  but your mileage may vary.
