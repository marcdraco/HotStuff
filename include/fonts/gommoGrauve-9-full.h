...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0x02, 0x22, 0x70, 0xC9, 0x01, 0x01, 0xBF, 0x7E, 0xE8, 0x81, 0x0B, 0x52,
  0x84, 0x00, 0x00, 0x0D, 0x7F, 0x71, 0xD3, 0x86, 0x1C, 0x3C, 0x70, 0xE1,
  0x83, 0x67, 0x8F, 0x2D, 0x3E, 0x5E, 0x40, 0x61, 0xE9, 0xF9, 0xC5, 0x83,
  0x87, 0x3E, 0x0C, 0x18, 0x33, 0x62, 0xCB, 0x97, 0x3C, 0xF4, 0x10, 0x0D,
  0x7F, 0x71, 0xD3, 0x86, 0x1C, 0x3C, 0x70, 0xE1, 0x83, 0x67, 0x8F, 0x2D,
  0x3E, 0x5E, 0x40, 0x61, 0xE9, 0xF9, 0xC5, 0x83, 0x87, 0x3E, 0x0C, 0x18,
  0x33, 0x62, 0xCB, 0x97, 0x3C, 0xF4, 0x10 };
...
const gfxglyph_t HotStuff9Glyphs[] PROGMEM = {
  ...
  {45,  1836,   7,  17,   7,    0,  -16 },   // 0x45 '-' 
  {91,  1851,   7,  18,   7,    0,  -17 },   // 0x46 '[' 
  {93,  1867,   7,  18,   7,    0,  -17 },   // 0x47 ']' 
  {40,  1883,   7,  18,   7,    0,  -17 },   // 0x48 '(' 
  {41,  1899,   7,  18,   7,    0,  -17 }   // 0x49 ')' 
};
...
// Approx. 2447 bytes -  but your mileage may vary.
