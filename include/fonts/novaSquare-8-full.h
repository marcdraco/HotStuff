...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0xE0, 0xF0, 0xD6, 0xFF, 0xFF, 0x0F, 0xF0, 0x3C, 0xFE, 0xFC, 0xCC, 0xCC,
  0xCC, 0xCC, 0xCC, 0xCC, 0xCF, 0xF3, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33,
  0x3F, 0x7B, 0x6D, 0xB6, 0xDB, 0x6D, 0x98, 0xCD, 0xB6, 0xDB, 0x6D, 0xB6,
  0xF0 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   692,   7,   1,   9,    1,   -5 },   // 0x45 '-' 
  {91,   693,   4,  16,   7,    2,  -13 },   // 0x46 '[' 
  {93,   701,   4,  16,   7,    2,  -13 },   // 0x47 ']' 
  {40,   709,   3,  15,   6,    2,  -12 },   // 0x48 '(' 
  {41,   715,   3,  15,   6,    2,  -12 }   // 0x49 ')' 
};
