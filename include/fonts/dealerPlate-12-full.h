...
const uint8_t HotStuff12Bitmaps[] PROGMEM = {
  ...
  0xFF, 0xFF, 0x50, 0x1C, 0xD0, 0x00, 0x70, 0xFF, 0xFE, 0x49, 0x24, 0x92,
  0x49, 0x24, 0x92, 0x49, 0x27, 0xE0, 0xFF, 0x33, 0x33, 0x33, 0x33, 0x33,
  0x33, 0x33, 0x33, 0x33, 0x33, 0x3F, 0xF0, 0x2F, 0xE9, 0x24, 0x92, 0x49,
  0x24, 0x92, 0x49, 0xB3, 0x20, 0x8C, 0x63, 0x33, 0x33, 0x33, 0x33, 0x33,
  0x33, 0x33, 0x33, 0x33, 0x6E, 0xC0 };
...
const gfxglyph_t HotStuff12Glyphs[] PROGMEM = {
  ...
  {45,  1099,   4,   2,   5,    0,  -10 },   // 0x45 '-' 
  {91,  1100,   3,  25,   5,    1,  -21 },   // 0x46 '[' 
  {93,  1110,   4,  25,   5,    0,  -21 },   // 0x47 ']' 
  {40,  1123,   3,  25,   5,    1,  -21 },   // 0x48 '(' 
  {41,  1133,   4,  25,   5,    0,  -21 }   // 0x49 ')' 
};
...
// Approx. 1678 bytes -  but your mileage may vary.
