...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0xF0, 0xF2, 0x49, 0x24, 0x92, 0x49, 0x27, 0xE4, 0x92, 0x49, 0x24, 0x92,
  0x4F, 0x12, 0x44, 0x48, 0x88, 0x88, 0x84, 0x44, 0x21, 0x84, 0x22, 0x21,
  0x11, 0x11, 0x12, 0x22, 0x48 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   648,   4,   1,   6,    1,   -4 },   // 0x45 '-' 
  {91,   649,   3,  16,   5,    2,  -12 },   // 0x46 '[' 
  {93,   655,   3,  16,   5,    0,  -12 },   // 0x47 ']' 
  {40,   661,   4,  16,   5,    1,  -12 },   // 0x48 '(' 
  {41,   669,   4,  16,   5,    0,  -12 }   // 0x49 ')' 
};
...
// Approx. 1209 bytes -  but your mileage may vary.
