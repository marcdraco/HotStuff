...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0xFF, 0x80, 0xFF, 0xBC, 0x80, 0xFF, 0xFF, 0xCF, 0xFF, 0x81, 0xFF, 0xFF,
  0xC0, 0xFC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCF, 0xF0, 0xF3, 0x33,
  0x33, 0x33, 0x33, 0x33, 0x33, 0x3F, 0xF0, 0x23, 0x36, 0x64, 0xCC, 0xCC,
  0xCC, 0xC4, 0x66, 0x31, 0x46, 0x18, 0x43, 0x18, 0x42, 0x18, 0xC4, 0x23,
  0x18, 0xCC, 0x66, 0x00 };
...
const gfxglyph_t HotStuff9Glyphs[] PROGMEM = {
  ...
  {45,   707,   5,   2,   9,    2,   -5 },   // 0x45 '-' 
  {91,   709,   4,  17,   9,    3,  -13 },   // 0x46 '[' 
  {93,   718,   4,  17,   9,    2,  -13 },   // 0x47 ']' 
  {40,   727,   4,  18,   9,    3,  -14 },   // 0x48 '(' 
  {41,   736,   5,  18,   9,    1,  -14 }   // 0x49 ')' 
};
...
// Approx. 1280 bytes -  but your mileage may vary.
