...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0x66, 0x00, 0x01, 0x00, 0xC0, 0xC0, 0x60, 0x60, 0x60, 0x30, 0x30, 0x18,
  0x18, 0x0C, 0x0C, 0x0C, 0x02, 0x00 };
...
// Approx. 1294 bytes -  but your mileage may vary.
