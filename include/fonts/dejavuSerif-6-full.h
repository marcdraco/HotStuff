...
const uint8_t HotStuff6Bitmaps[] PROGMEM = {
  ...
  0xF0, 0x58, 0xFF, 0xF3, 0xC0, 0xF3, 0xC0, 0xE0, 0xF2, 0x49, 0x24, 0x93,
  0x80, 0xE4, 0x92, 0x49, 0x27, 0x80, 0x2A, 0x49, 0x24, 0x88, 0x80, 0x89,
  0x12, 0x49, 0x4A, 0x00 };
...
const gfxglyph_t HotStuff6Glyphs[] PROGMEM = {
  ...
  {45,   523,   3,   1,   4,    1,   -3 },   // 0x45 '-' 
  {91,   524,   3,  11,   5,    1,   -9 },   // 0x46 '[' 
  {93,   529,   3,  11,   5,    1,   -9 },   // 0x47 ']' 
  {40,   534,   3,  11,   5,    1,   -9 },   // 0x48 '(' 
  {41,   539,   3,  11,   5,    1,   -9 }   // 0x49 ')' 
};
