...
const uint8_t HotStuff12Bitmaps[] PROGMEM = {
  ...
  0xF7, 0x36, 0xC6, 0xF0, 0xFA, 0x0E, 0xFF, 0x80, 0x1E, 0xCF, 0xF7, 0x1F,
  0x83, 0xC0, 0xF0, 0x0C, 0x03, 0x00, 0x60, 0x9F, 0xF1, 0xF0, 0x0F, 0x1F,
  0x30, 0x30, 0xFF, 0xFF, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0xFE,
  0xFE };
...
const gfxglyph_t HotStuff12Glyphs[] PROGMEM = {
  ...
  {99,   224,  10,  11,  13,    0,  -10 },   // 0x0E 'c' 
  {102,   238,   8,  15,  13,    2,  -14 }   // 0x0F 'f' 
};
...
// Approx. 379 bytes -  but your mileage may vary.
