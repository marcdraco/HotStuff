...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0x42, 0x20, 0xE0, 0xF0, 0x6D, 0xE8, 0xFF, 0x30, 0xF0, 0x0F, 0xF0, 0xF2,
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   718,   4,   1,  10,    3,   -4 },   // 0x45 '-' 
  {91,   719,   3,  14,  10,    4,  -11 },   // 0x46 '[' 
  {93,   725,   3,  14,  10,    3,  -11 },   // 0x47 ']' 
  {40,   731,   4,  14,  10,    3,  -11 },   // 0x48 '(' 
  {41,   738,   4,  14,  10,    2,  -11 }   // 0x49 ')' 
};
...
// Approx. 1277 bytes -  but your mileage may vary.
