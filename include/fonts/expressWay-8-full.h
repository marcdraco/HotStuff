...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0x49, 0xA8, 0x70, 0x80, 0x69, 0x60, 0xFF, 0xAA, 0x0C, 0x84, 0xF8, 0xF2,
  0x49, 0x24, 0x92, 0x49, 0x24, 0x9C, 0xE4, 0x92, 0x49, 0x24, 0x92, 0x49,
  0x3C, 0x36, 0x44, 0x88, 0x88, 0x88, 0x88, 0x88, 0x44, 0x63, 0xC6, 0x22,
  0x11, 0x11, 0x11, 0x11, 0x11, 0x22, 0x6C };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   694,   5,   1,   6,    0,   -5 },   // 0x45 '-' 
  {91,   695,   3,  18,   6,    2,  -14 },   // 0x46 '[' 
  {93,   702,   3,  18,   6,    1,  -14 },   // 0x47 ']' 
  {40,   709,   4,  18,   6,    2,  -14 },   // 0x48 '(' 
  {41,   718,   4,  18,   6,    0,  -14 }   // 0x49 ')' 
};
...
// Approx. 1259 bytes -  but your mileage may vary.
