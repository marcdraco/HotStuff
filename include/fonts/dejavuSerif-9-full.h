...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0x0F, 0xF8, 0xFC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCF, 0xF8, 0xC6,
  0x31, 0x8C, 0x63, 0x18, 0xC6, 0x31, 0x8C, 0x7F, 0x09, 0x88, 0xC4, 0x63,
...
const gfxglyph_t HotStuff9Glyphs[] PROGMEM = {
  ...
  {45,  1033,   5,   1,   6,    1,   -5 },   // 0x45 '-' 
  {91,  1034,   4,  16,   7,    2,  -13 },   // 0x46 '[' 
  {93,  1042,   5,  16,   7,    1,  -13 },   // 0x47 ']' 
  {40,  1052,   5,  16,   7,    1,  -13 },   // 0x48 '(' 
  {41,  1062,   5,  16,   7,    1,  -13 }   // 0x49 ')' 
};
