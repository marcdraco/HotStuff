...
const uint8_t HotStuff12Bitmaps[] PROGMEM = {
  ...
  0xB6, 0xDB, 0x6D, 0x06, 0xF8, 0xFF, 0x80, 0x07, 0xFC, 0xFF, 0xFF, 0xE0,
  0x7F, 0xEC, 0x30, 0xC3, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0xC3, 0x0C, 0x30,
  0xC3, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0xFF, 0xF0, 0xFF, 0xF0, 0xC3, 0x0C,
  0x30, 0xC3, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0xC3, 0x0C,
  0x30, 0xC3, 0x7F, 0xE0, 0x08, 0x63, 0x8C, 0x71, 0x86, 0x38, 0xC3, 0x0C,
  0x30, 0xC3, 0x0C, 0x30, 0xC3, 0x0E, 0x18, 0x61, 0x83, 0x0E, 0x18, 0x20,
  0x41, 0x87, 0x0C, 0x38, 0x61, 0x86, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0xC3,
  0x0C, 0x31, 0xC6, 0x18, 0x63, 0x1C, 0x61, 0x00 };
...
const gfxglyph_t HotStuff12Glyphs[] PROGMEM = {
  ...
  {45,  1437,  10,   2,  13,    2,   -9 },   // 0x45 '-' 
  {91,  1440,   6,  26,  13,    5,  -21 },   // 0x46 '[' 
  {93,  1460,   6,  26,  13,    2,  -21 },   // 0x47 ']' 
  {40,  1480,   6,  26,  13,    5,  -21 },   // 0x48 '(' 
  {41,  1500,   6,  26,  13,    2,  -21 }   // 0x49 ')' 
};
...
// Approx. 2052 bytes -  but your mileage may vary.
