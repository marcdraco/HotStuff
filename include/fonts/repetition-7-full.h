...
const uint8_t HotStuff7Bitmaps[] PROGMEM = {
  ...
  0x68, 0xDD, 0x88, 0x08, 0x88, 0x8D, 0xDD, 0x11, 0x01, 0x11, 0x1D, 0x21,
  0x41, 0x20, 0x44, 0x81, 0x10, 0x48, 0x50, 0x02, 0x00, 0x08, 0x40, 0x02,
  0x10, 0x00, 0x81, 0x00 };
...
const gfxglyph_t HotStuff7Glyphs[] PROGMEM = {
  ...
  {91,   517,   4,  10,   8,    2,   -9 },   // 0x45 '[' 
  {93,   522,   4,  10,   8,    2,   -9 },   // 0x46 ']' 
  {40,   527,   3,  10,   8,    2,   -9 },   // 0x47 '(' 
  {41,   531,   3,  10,   8,    2,   -9 },   // 0x48 ')' 
  {47,   535,   7,  10,   8,    0,   -9 }   // 0x49 '/' 
};
