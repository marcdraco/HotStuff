...
const uint8_t HotStuff7Bitmaps[] PROGMEM = {
  ...
  0xE0, 0xF8, 0xFF, 0x3F, 0x4F, 0x81, 0xF0, 0xFC, 0xF2, 0x49, 0x24, 0x92,
  0x60, 0xE3, 0x36, 0x33, 0x33, 0x33, 0x36, 0x26, 0x44, 0x88, 0x8C, 0x44,
  0x62, 0x48, 0x92, 0x49, 0x2D, 0x40 };
...
const gfxglyph_t HotStuff7Glyphs[] PROGMEM = {
  ...
  {45,   487,   6,   1,   8,    1,   -3 },   // 0x45 '-' 
  {91,   488,   3,  12,   8,    3,   -9 },   // 0x46 '[' 
  {93,   493,   4,  12,   8,    2,   -9 },   // 0x47 ']' 
  {40,   499,   4,  12,   8,    2,   -9 },   // 0x48 '(' 
  {41,   505,   3,  12,   8,    2,   -9 }   // 0x49 ')' 
};
...
// Approx. 1042 bytes -  but your mileage may vary.
