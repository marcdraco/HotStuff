...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0xFF, 0xFF, 0xF0, 0xF0, 0xF0, 0x0F, 0xFF, 0xFF, 0xFF, 0xFC, 0x30, 0xC3,
  0x0C, 0x30, 0xC3, 0x0C, 0x30, 0xFF, 0xF0, 0xFF, 0xF0, 0xC3, 0x0C, 0x30,
  0xC3, 0x0C, 0x30, 0xC3, 0xFF, 0xF0, 0x0F, 0x0F, 0x30, 0x30, 0xC0, 0xC0,
  0xC0, 0xC0, 0xC0, 0xC0, 0x30, 0x30, 0x0F, 0x0F, 0xF0, 0xF0, 0x0C, 0x0C,
  0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x0C, 0x0C, 0xF0, 0xF0 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,  1026,   8,   2,  10,    0,   -7 },   // 0x45 '-' 
  {91,  1028,   6,  14,  10,    2,  -13 },   // 0x46 '[' 
  {93,  1039,   6,  14,  10,    2,  -13 },   // 0x47 ']' 
  {40,  1050,   8,  14,  10,    0,  -13 },   // 0x48 '(' 
  {41,  1064,   8,  14,  11,    2,  -13 }   // 0x49 ')' 
};
...
// Approx. 1610 bytes -  but your mileage may vary.
