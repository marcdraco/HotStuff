...
const uint8_t HotStuff9Bitmaps[] PROGMEM = {
  ...
  0x80, 0x28, 0xA0, 0xA8, 0xFC, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0x03, 0x00,
  0x3F, 0xFC, 0x00, 0xC3, 0x0C, 0x30, 0xC3, 0x00, 0x30, 0x3F, 0x08, 0x09,
  0x00, 0x02, 0x10, 0x01, 0x00, 0x10, 0x80, 0x08, 0x10, 0x00, 0x21, 0x01,
  0x01, 0x00 };
...
const gfxglyph_t HotStuff9Glyphs[] PROGMEM = {
  ...
  {45,   687,   5,   1,  10,    2,   -4 },   // 0x45 '-' 
  {91,   688,   6,  12,  10,    2,  -11 },   // 0x46 '[' 
  {93,   697,   6,  12,  10,    2,  -11 },   // 0x47 ']' 
  {40,   706,   5,  12,  10,    2,  -11 },   // 0x48 '(' 
  {41,   714,   5,  12,  10,    2,  -11 }   // 0x49 ')' 
};
...
// Approx. 1254 bytes -  but your mileage may vary.
