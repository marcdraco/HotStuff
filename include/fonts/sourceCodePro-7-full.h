...
const uint8_t HotStuff7Bitmaps[] PROGMEM = {
  ...
  0xB5, 0x80, 0xDB, 0x6C, 0x37, 0xC0, 0xDF, 0x01, 0xBE, 0xF8, 0xF8, 0x88,
  0x88, 0x88, 0x88, 0x8F, 0xF8, 0xC6, 0x31, 0x8C, 0x63, 0x18, 0xC7, 0xF0,
  0x27, 0x4C, 0x88, 0x88, 0x8C, 0x46, 0x30, 0x8C, 0x62, 0x33, 0x33, 0x32,
  0x6C, 0x80 };
...
const gfxglyph_t HotStuff7Glyphs[] PROGMEM = {
  ...
  {45,   513,   5,   1,   8,    2,   -4 },   // 0x45 '-' 
  {91,   514,   4,  12,   8,    3,   -9 },   // 0x46 '[' 
  {93,   520,   5,  12,   8,    1,   -9 },   // 0x47 ']' 
  {40,   528,   4,  13,   8,    3,   -9 },   // 0x48 '(' 
  {41,   535,   4,  13,   8,    2,   -9 }   // 0x49 ')' 
};
