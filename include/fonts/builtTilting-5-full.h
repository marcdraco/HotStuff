...
const uint8_t HotStuff5Bitmaps[] PROGMEM = {
  ...
  0x52, 0xC0, 0xDD, 0xDF, 0x33, 0x77, 0x80, 0xC0, 0xFF, 0x88, 0xC0, 0xEA,
  0xAA, 0xAB, 0xD5, 0x55, 0x57, 0x6A, 0xAA, 0xA9, 0x95, 0x55, 0x56 };
...
const gfxglyph_t HotStuff5Glyphs[] PROGMEM = {
  ...
  {45,   202,   2,   1,   3,    0,   -3 },   // 0x45 '-' 
  {91,   203,   2,  12,   3,    1,   -9 },   // 0x46 '[' 
  {93,   206,   2,  12,   3,    0,   -9 },   // 0x47 ']' 
  {40,   209,   2,  12,   3,    1,   -9 },   // 0x48 '(' 
  {41,   212,   2,  12,   3,    0,   -9 }   // 0x49 ')' 
};
...
// Approx. 747 bytes -  but your mileage may vary.
