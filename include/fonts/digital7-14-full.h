...
const uint8_t HotStuff14Bitmaps[] PROGMEM = {
  ...
  0xF0, 0xF0, 0xF0, 0x00, 0xF0, 0xFF, 0xFF, 0xFB, 0xB1, 0x8C, 0x63, 0x18,
  0x84, 0x31, 0x8C, 0x63, 0x18, 0x77, 0xC0, 0xEB, 0xC6, 0x31, 0x8C, 0x63,
  0x08, 0x46, 0x31, 0x8C, 0x63, 0x7F, 0x40, 0x3C, 0xFC, 0x30, 0xC3, 0x0C,
  0x30, 0x82, 0x0C, 0x30, 0xC3, 0x0C, 0x30, 0x7C, 0xF0, 0xF3, 0xC0, 0xC3,
  0x0C, 0x30, 0xC3, 0x04, 0x10, 0xC3, 0x0C, 0x30, 0xC3, 0xFB, 0xC0 };
...
const gfxglyph_t HotStuff14Glyphs[] PROGMEM = {
  ...
  {45,  1409,   8,   2,  12,    2,   -9 },   // 0x45 '-' 
  {91,  1411,   5,  18,  12,    1,  -17 },   // 0x46 '[' 
  {93,  1423,   5,  18,  12,    6,  -17 },   // 0x47 ']' 
  {40,  1435,   6,  18,  12,    1,  -17 },   // 0x48 '(' 
  {41,  1449,   6,  18,  12,    5,  -17 }   // 0x49 ')' 
};
