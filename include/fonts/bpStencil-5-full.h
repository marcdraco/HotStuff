...
const uint8_t HotStuff5Bitmaps[] PROGMEM = {
  ...
  0x40, 0x03, 0x6D, 0x86, 0xC0, 0xD8, 0x6C, 0x00, 0x00, 0xF8, 0x00, 0x1F,
  0x6D, 0xB6, 0xDC, 0x00, 0x1D, 0xB6, 0xDB, 0x7C, 0x00, 0x01, 0x08, 0x84,
  0x21, 0x0C, 0x21, 0x00, 0x02, 0x08, 0x42, 0x10, 0x84, 0x22, 0x00 };
...
const gfxglyph_t HotStuff5Glyphs[] PROGMEM = {
  ...
  {45,   512,   7,   3,   6,   -1,   -3 },   // 0x45 '-' 
  {91,   515,   3,  11,   6,    1,   -8 },   // 0x46 '[' 
  {93,   520,   3,  11,   6,    1,   -8 },   // 0x47 ']' 
  {40,   525,   5,  11,   6,    0,   -8 },   // 0x48 '(' 
  {41,   532,   5,  11,   6,    0,   -8 }   // 0x49 ')' 
};
...
// Approx. 1071 bytes -  but your mileage may vary.
