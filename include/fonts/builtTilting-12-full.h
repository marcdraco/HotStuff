...
const uint8_t HotStuff12Bitmaps[] PROGMEM = {
  ...
  0xFC, 0x00, 0x0F, 0xC0, 0xFF, 0xF1, 0x8C, 0x63, 0x18, 0xC6, 0x31, 0x8C,
  0x63, 0x18, 0xC6, 0x31, 0x8C, 0x63, 0x18, 0xC6, 0x31, 0xFF, 0x80, 0xFF,
  0xC6, 0x31, 0x8C, 0x63, 0x18, 0xC6, 0x31, 0x8C, 0x63, 0x18, 0xC6, 0x31,
  0x8C, 0x63, 0x18, 0xC7, 0xFF, 0x80, 0x33, 0x66, 0x4C, 0xCC, 0xC8, 0x88,
  0x88, 0x88, 0x88, 0x88, 0x8C, 0xCC, 0x44, 0x62, 0x30, 0xCC, 0x66, 0x23,
  0x33, 0x31, 0x11, 0x11, 0x11, 0x11, 0x11, 0x33, 0x33, 0x26, 0x64, 0xC0,
  0x03, 0x03, 0x02, 0x06, 0x06, 0x06, 0x04, 0x0C, 0x0C, 0x0C, 0x08, 0x18,
  0x18, 0x18, 0x10, 0x10, 0x30, 0x30, 0x20, 0x20, 0x60, 0x60, 0x40, 0x40,
  0xC0 };
...
const gfxglyph_t HotStuff12Glyphs[] PROGMEM = {
  ...
  {91,  1060,   5,  29,   8,    2,  -22 },   // 0x45 '[' 
  {93,  1079,   5,  29,   8,    1,  -22 },   // 0x46 ']' 
  {40,  1098,   4,  29,   8,    3,  -22 },   // 0x47 '(' 
  {41,  1113,   4,  29,   8,    1,  -22 },   // 0x48 ')' 
  {47,  1128,   8,  25,   8,    0,  -20 }   // 0x49 '/' 
};
...
// Approx. 1685 bytes -  but your mileage may vary.
