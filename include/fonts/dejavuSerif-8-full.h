...
const uint8_t HotStuff8Bitmaps[] PROGMEM = {
  ...
  0x3C, 0xF0, 0xF2, 0x49, 0x24, 0x92, 0x49, 0xC0, 0xE4, 0x92, 0x49, 0x24,
  0x93, 0xC0, 0x29, 0x49, 0x24, 0x92, 0x44, 0x88, 0x89, 0x22, 0x49, 0x24,
  0xA4, 0xA0 };
...
const gfxglyph_t HotStuff8Glyphs[] PROGMEM = {
  ...
  {45,   841,   4,   1,   5,    1,   -4 },   // 0x45 '-' 
  {91,   842,   3,  14,   6,    1,  -11 },   // 0x46 '[' 
  {93,   848,   3,  14,   6,    1,  -11 },   // 0x47 ']' 
  {40,   854,   3,  15,   6,    1,  -11 },   // 0x48 '(' 
  {41,   860,   3,  15,   6,    1,  -11 }   // 0x49 ')' 
};
...
// Approx. 1398 bytes -  but your mileage may vary.
